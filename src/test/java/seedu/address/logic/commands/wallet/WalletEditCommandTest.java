...
public class WalletEditCommandTest {
    ...
    public void execute_income_allFieldsSpecifiedUnfilteredList_success() {
        Income editedTransaction = new TransactionBuilder().buildIncome();
        ...
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new Wallet(model.getWallet()), new UserPrefs());
        expectedModel.setIncome(model.getFilteredIncomeList().get(0), editedTransaction);
