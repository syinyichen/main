...
public class PeopleEditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Debt updatedDebt = personToEdit.getUserOwe(); // edit command does not allow editing of debt
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(personToEdit.getTags());

        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedDebt, updatedTags);
    }
