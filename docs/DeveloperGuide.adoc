...
.. Test case: `wallet edit 1 n/Chicken Rice` +
   Expected: Transaction 1 is now updated with new description _Chicken Rice_. A success message shown in the result display.
.. Test case: `wallet edit 1 n/Dinner $/12.00 d/02/02/2020 t/food` +
   Expected: Transaction 1 is now updated with new description _Dinner_ with amount _$12.00_, recorded under the date _02/02/2020_ with tag _Food_.
...
*** `wallet find $/yyyy/mm/dd` (where date is in the wrong format) +
   Expected: Similar to previous
//end::testWalletFind
