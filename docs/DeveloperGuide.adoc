...
This command can be accessed from `Logic#execute()`. It edits the `transaction`, indicated by the index specified, with the new details supplied with the command.
