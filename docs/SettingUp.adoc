...
. Fork https://github.com/AY1920S2-CS2103T-W12-3/main[this repo], and clone the fork to your computer
...
When you are ready to start coding, we recommend that you get some sense of the overall design by reading about <<DeveloperGuide#Design-Architecture, Sharkie's architecture>>.
