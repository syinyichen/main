...
** Suppose you want to search for transactions with description containing keyword `rice` and transactions with description containing keyword `soup`.
...
** Suppose you want to search for transactions with amount ranging between `$7.00` to `$7.99` and amount between `$30.00` to `$30.99`.
* The command you would enter is `wallet find $/7 30`.
* This tells *Sharkie* that you want to look for transactions with cost or income from `$7.00` to `$7.99` and transactions with cost or income from `$30.00` to `$30.99`.
...
** Suppose you want to search for transactions with date `10/10/2020` and transactions with date `11/11/2020`.
...
** Suppose you want to search for transactions with tag `food` and transactions with tag `shopping`.
