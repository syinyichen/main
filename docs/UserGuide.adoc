...
[[Features]]
== Features
This section elaborates on the five unique features that make up Sharkie.
...
NOTE: Check out <<budget-command, 5.2.7 Setting a budget>> to learn how to budget your monthly spending with Sharkie.
...
//tag::globalcommands[]
=== Global Commands
Global commands are general commands which help you to interact with Sharkie.
...
=== Wallet Commands
Wallet commands are commands that pertain to your monetary information. If you want to record down transactions or set a monthly budget for yourself, these commands are your best friends.
