...
Suppose you want to clear all the transactions, the command you would enter is our `wallet clear` command. +

Clear all transactions from the wallet. +
Format: `wallet clear`
...
* Data cleared cannot be restored after using wallet clear command.
====

Example:

* `wallet clear`
Removes all transactions in the wallet.
