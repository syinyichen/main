...
NOTE: You may visit <<add-expense-command, Adding an expense>> or <<add-income-command, Adding an income>>
...
NOTE: You may visit <<add-person, Adding a person>>, <<list-people, Listing all contacts>>,
<<find-person, Finding a person>>, <<edit-person, Editing a person>>, <<delete-person, Deleting a person>>, <<peopleclear, Clearing all contacts>>
...
NOTE: Check out <<budget-command, Setting a budget>> to learn how to budget your monthly spending with Sharkie.
