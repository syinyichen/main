...
The following are the limitations of `people add` command, which you would need to take note:
...
The following is the limitations of `people received` command, which you would need to take note:
...
The following is the limitations of `people remind` command, which you would need to take note:
...
The following are the limitations of `people find` command, which you would need to take note:
