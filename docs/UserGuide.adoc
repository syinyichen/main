...
specific person in the address book. +
_Still confused? Find out more about <<personIndexFAQ, what is a person's index>>._ +

*Example*:

* Suppose you want to update John's email, and John is the first person in your address book.
...
* Suppose you want to delete "Betsy" from your address book, and "Betsy" is the first person in the list.

** The command that you would enter is `people delete 1`.
** *Sharkie* will delete "Betsy" from the address book.
...
Suppose you want to remind all your friends in your address book to return you your money,
...
* Suppose you want to remind all your friends in your address book who have yet to repay you.

** The command you would enter is `people remindall`.
** This requests *Sharkie* to send an email to everyone in your address book who have yet to repay you.
...
entire list of people in your address book. The command you would enter is our `people list` command. +
...
****
Install the app in the other computer and overwrite the empty data file *Sharkie* creates with the file that contains the data of your previous address book folder.
****
...
****
A `transaction's index` is the index number shown in the displayed transaction list in *Sharkie*. It indicates a specific transaction in the address book.
...
image::transactionIndexFAQ.jpg[width=900]
****
...
****
A `person's index` is the index number shown in the displayed person list in *Sharkie*. It indicates a specific person in the address book.
...
|===
| *Command*  | *Format* | *Expected outcome*
|`add` |[gray]#`people add n/<name> p/<phone number> e/<email address>`# | Helps you add a contact to your address book, with the particulars that you have entered.
|`clear`|[gray]#`people clear`# | Clears all your contacts in your address book.
|`delete` | [gray]#`people delete <index>`# | Deletes your contact at the index you have selected.
|`edit` | [gray]#`people edit <index> [n/<name>] [p/<phone number>] [e/<email address>]`# | Edits your contact in the address book at the index selected with the given arguments.
|`find` | [gray]#`people find n/<keyword> [<keyword>...]`# +
or [gray]#`people find p/<keyword> [<keyword>...]`# +
or [gray]#`people find e/<keyword> [<keyword>...]`# +
or [gray]#`people find t/<keyword> [<keyword>...]`# | Finds your contact(s) within your address book using the arguments you have provided.
|`lend` | [gray]#`people lend <index> n/<description> $/<amount> [d/<date:dd/mm/yyyy>]`# | Records a loan to your contact at the index selected in your address book.
| `list` | [gray]#`people list`# | Lists all your contacts that have been recorded by *Sharkie* in the address book.
| `owe` | [gray]#`people owe <index> n/<description> $/<amount> [d/<date:dd/mm/yyyy>]`# | Records a debt to your contact at the index selected in your address book.
