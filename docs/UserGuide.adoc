...
If you owe a person money and you want to record the debt, the command you would enter is 'people owe' command. +

Format: `people owe <index> n/<description> $/<amount> [d/<date:dd/mm/yyyy>]`

This command will record the amount of money specified in `<amount>` you owe to the person at the specified `<index>`.

====
*Command Format*

The following are the restrictions of `people owe` command, which you should take note of:
...
[TIP] The `<date:dd/mm/yyyy>` is optional. If `<date:dd/mm/yyyy>` is not specified, the date that you record the debt will be used.

*Example*:

* Suppose you owe Grace, who is the fourth person in the person list, $5 for food on 10 October 2020.

** The command you would enter is `people owe 4 n/food $/5.00 d/10/10/2020`
** This records that you owe Grace $5.00 on 10/10/2020. +
