...
during execution of commands like `people remind`. (Pull request https://github.com/AY1920S2-CS2103T-W12-3/main/pulls[#148])
...
*** Edited various parts of the User Guide. (Pull requests https://github.com/AY1920S2-CS2103T-W12-3/main/pulls[#49])
